...
// These bytecodes only maintain AS_REFERENCE_DEBUGGING state in the interpreter.
// StaticJIT accepts them so editor-generated bytecode can still be emitted as AOT.
